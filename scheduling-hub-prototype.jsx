...
import { Check, X, AlertTriangle, Users, Package, Clock, ChevronLeft, ChevronRight, Printer, Calendar, Lock, Unlock } from "lucide-react";
...
export default function SchedulingHub() {
  ...
  function cyclePlaceholderCell(groupKey, slotIdx, weekday) {
    ...
    setPlaceholderPatterns((prev) => {
      ...
      next[groupKey][slotIdx][weekday] = cycle[(idx + 1) % cycle.length];
      return next;
    });
  }
  ...
  function cycleCell(name, weekday, role) {
    ...
    setPatterns((prev) => {
      ...
      next[name][weekday] = nextInCycle(next[name][weekday], role, name);
      return next;
    });
  }
